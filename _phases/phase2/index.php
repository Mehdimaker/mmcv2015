        ...
        <div class="container ">
            ...
            <div class="navbar-header">
                ...
                <a class="navbartitle" href="#menu1">
                    <img src="img/logonav.png" style="height:32px;">
                </a>
            </div>
            <div class="side-collapse in">
                <div class="navbar-collapse">
                    <ul class="nav navbar-nav ">
                        <li><a href="#menu1"> ACCUEIL</a>
                        </li>
                        <li><a href="#menu2"> EXPERIENCE</a>
                        </li>
                        <li><a href="#menu3"> COMPETENCES</a>
                        </li>
                        <li><a href="#menu4"> REALISATIONS</a>
                        </li>
                        <li><a href="#menu5"> CONTACT</a>
                        </li>
                    </ul>
                </div>
...
<div class=" side-collapse-container">
        ...
        <section id="menu2">
            ...
            <div id="titresection">
                <img src="img/student.png"><span>Mon expèrience</span>
            </div>
            <div class="container">
                <div class="row">
        ...
        <section id="menu3">
            <div id="titresection">
                <img src="img/skills.png"><span>Mes compétences</span>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-4">
        ...
        <section id="menu4">
            <div id="titresection">
                <img src="img/pictures.png"><span>Mes réalisations</span>
            </div>
            <div class="container">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="item active ad1">
                                    <div class="carousel-caption">
                                        ...
                                        <a href="#ad1Modal" data-toggle="modal">
                                ...
                                <div class="item ad2">
                                    <div class="carousel-caption">
                                        <!-- Button trigger modal -->
                                        <a href="#ad2Modal" data-toggle="modal">
                                            <span class="glyphicon glyphicon glyphicon-search"></span> 
                                        </a>
            ...
            <!-- Modal ad1-->
            <div class="modal fade " id="ad1Modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <a class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove"></span>
                        </a>
                            <h4 class="modal-title" id="myModalLabel">Website MMCV Responsive </h4>
                        </div>
                        <div class="modal-body">
                            <img src="img/rea/responsive.jpg" width="100%;">
                        </div>
                        <div class="modal-footer">
                            <p>Réalisé via l'ide Brackets
                                <br>et Framework Bootstrap</p>
            ...
            <!-- Modal ad2-->
            <div class="modal fade " id="ad2Modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <a class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove"></span>
                        </a>
                            <h4 class="modal-title" id="myModalLabel">Maquette Graphique MMCV</h4>
                        </div>
                        <div class="modal-body">
                            <img src="img/rea/imagemaquette.jpg" width="100%;">
                        </div>
                        <div class="modal-footer">
                            <p>Réalisé sous photoshop</p>
                        </div>
        ...
        <section id="menu5">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class=" col-md-5 ">
                        <div id="titresection">
                            <img src="img/contact.png"><span>Contactez moi !</span>
                        </div>
                        <div id="litlequotation">
                            ...
                            <p>N’hésitez pas à me contacter !
                                <br/>Je vous répondrais au plus vite !</p>
                        </div>
                    ...
                    <div class="col-md-offset-2 col-md-5">
                        <div id="titresection">
                            <img src="img/pointer.png"><span>Rencontrez moi !</span>
                        </div>
                        <div id="litlequotation">
                            <img src="img/quotationleft.png" class="left">
                            <img src="img/quotationright.png" class="right">
                            <p>Disponible sur Paris pour rendez-vous !
    ...
    <script src="js/sectionminheight.js"></script>
    <script src="js/addnavbar-inverse.js"></script>
