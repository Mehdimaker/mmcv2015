               ...
               <img class="cornet "src="img/cornet.png" >
                <div class="navbar-collapse">
                    <ul class="nav navbar-nav">
                        <li>
                            <a href="#menu1"> <span class="glyphicon glyphicon-home"></span>ACCUEIL</a>
                        </li>
                        <li>
                            <a href="#menu2"> <span class="glyphicon glyphicon-education"></span>EXPERIENCE</a>
                        </li>
                        <li>
                            <a href="#menu3"> <span class="glyphicon glyphicon-stats"></span>COMPETENCES</a>
                        </li>
                        <li>
                            <a href="#menu4"> <span class="glyphicon glyphicon-picture"></span>REALISATIONS</a>
                        </li>
                        <li>
                            <a href="#menu5"> <span class="glyphicon glyphicon-comment"></span>CONTACT</a>
                        </li>
                    </ul>
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button class="close" data-dismiss="modal" aria-label="Close"><span class="glyphicon glyphicon-remove"></span>
                        </button>
            ...
            <div class="modal fade " id="ad2Modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <img src="img/rea/imagemaquette.jpg" style="height:100%">
                        </div>
                        <div class="modal-footer">
                            <p>Réalisé sous photoshop</p>
                        </div>
